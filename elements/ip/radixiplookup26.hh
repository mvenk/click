// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP26_HH
#define CLICK_RADIXIPLOOKUP26_HH
...
RadixIPLookup26(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup26 : public IPRouteTable { public:

    RadixIPLookup26();
    ~RadixIPLookup26();

    const char *class_name() const		{ return "RadixIPLookup26"; }
