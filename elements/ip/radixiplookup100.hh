// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP100_HH
#define CLICK_RADIXIPLOOKUP100_HH
...
RadixIPLookup100(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup100 : public IPRouteTable { public:

    RadixIPLookup100();
    ~RadixIPLookup100();

    const char *class_name() const		{ return "RadixIPLookup100"; }
