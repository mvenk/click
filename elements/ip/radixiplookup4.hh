// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP4_HH
#define CLICK_RADIXIPLOOKUP4_HH
...
RadixIPLookup4(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup4 : public IPRouteTable { public:

    RadixIPLookup4();
    ~RadixIPLookup4();

    const char *class_name() const		{ return "RadixIPLookup4"; }
