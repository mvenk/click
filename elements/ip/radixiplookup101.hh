// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP101_HH
#define CLICK_RADIXIPLOOKUP101_HH
...
RadixIPLookup101101101(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup101 : public IPRouteTable { public:

    RadixIPLookup101();
    ~RadixIPLookup101();

    const char *class_name() const		{ return "RadixIPLookup101"; }
