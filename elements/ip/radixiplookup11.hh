// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP11_HH
#define CLICK_RADIXIPLOOKUP11_HH
...
RadixIPLookup11(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup11 : public IPRouteTable { public:

    RadixIPLookup11();
    ~RadixIPLookup11();

    const char *class_name() const		{ return "RadixIPLookup11"; }
    const char *port_count() const		{ return "1/-"; }
    const char *processing() const		{ return PUSH; }

    static const int lglvl1 = 8;
    static const int lglvln = 8;
