// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP25_HH
#define CLICK_RADIXIPLOOKUP25_HH
...
class RadixIPLookup25 : public IPRouteTable { public:

    RadixIPLookup25();
    ~RadixIPLookup25();

    const char *class_name() const		{ return "RadixIPLookup25"; }
