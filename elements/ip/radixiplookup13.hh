// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP13_HH
#define CLICK_RADIXIPLOOKUP13_HH
...
RadixIPLookup13(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup13 : public IPRouteTable { public:

    RadixIPLookup13();
    ~RadixIPLookup13();

    const char *class_name() const		{ return "RadixIPLookup13"; }
