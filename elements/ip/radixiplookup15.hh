// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP15_HH
#define CLICK_RADIXIPLOOKUP15_HH
...
RadixIPLookup15(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup15 : public IPRouteTable { public:

    RadixIPLookup15();
    ~RadixIPLookup15();

    const char *class_name() const		{ return "RadixIPLookup15"; }
