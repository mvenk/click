// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP6_HH
#define CLICK_RADIXIPLOOKUP6_HH
...
RadixIPLookup6(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup6 : public IPRouteTable { public:

    RadixIPLookup6();
    ~RadixIPLookup6();

    const char *class_name() const		{ return "RadixIPLookup6"; }
