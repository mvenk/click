// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP5_HH
#define CLICK_RADIXIPLOOKUP5_HH
...
class RadixIPLookup5 : public IPRouteTable { public:

    RadixIPLookup5();
    ~RadixIPLookup5();

    const char *class_name() const		{ return "RadixIPLookup5"; }
