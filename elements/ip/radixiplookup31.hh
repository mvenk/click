// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP31_HH
#define CLICK_RADIXIPLOOKUP31_HH
...
RadixIPLookup31(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup31 : public IPRouteTable { public:

    RadixIPLookup31();
    ~RadixIPLookup31();

    const char *class_name() const		{ return "RadixIPLookup31"; }
