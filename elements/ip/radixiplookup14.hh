// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP14_HH
#define CLICK_RADIXIPLOOKUP14_HH
...
RadixIPLookup14(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup14 : public IPRouteTable { public:

    RadixIPLookup14();
    ~RadixIPLookup14();

    const char *class_name() const		{ return "RadixIPLookup14"; }
