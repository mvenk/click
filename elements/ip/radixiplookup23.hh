// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP23_HH
#define CLICK_RADIXIPLOOKUP23_HH
...
RadixIPLookup23(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup23 : public IPRouteTable { public:

    RadixIPLookup23();
    ~RadixIPLookup23();

    const char *class_name() const		{ return "RadixIPLookup23"; }
