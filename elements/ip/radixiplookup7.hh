// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP7_HH
#define CLICK_RADIXIPLOOKUP7_HH
...
RadixIPLookup7(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup7 : public IPRouteTable { public:

    RadixIPLookup7();
    ~RadixIPLookup7();

    const char *class_name() const		{ return "RadixIPLookup7"; }
