// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP27_HH
#define CLICK_RADIXIPLOOKUP27_HH
...
RadixIPLookup27(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup27 : public IPRouteTable { public:

    RadixIPLookup27();
    ~RadixIPLookup27();

    const char *class_name() const		{ return "RadixIPLookup27"; }
