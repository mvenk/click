// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP21_HH
#define CLICK_RADIXIPLOOKUP21_HH
...
RadixIPLookup21(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup21 : public IPRouteTable { public:

    RadixIPLookup21();
    ~RadixIPLookup21();

    const char *class_name() const		{ return "RadixIPLookup21"; }
