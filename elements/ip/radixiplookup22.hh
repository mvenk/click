// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP22_HH
#define CLICK_RADIXIPLOOKUP22_HH
...
class RadixIPLookup22 : public IPRouteTable { public:

    RadixIPLookup22();
    ~RadixIPLookup22();

    const char *class_name() const		{ return "RadixIPLookup22"; }
