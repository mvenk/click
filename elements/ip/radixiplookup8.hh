// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP8_HH
#define CLICK_RADIXIPLOOKUP8_HH
...
RadixIPLookup8(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup8 : public IPRouteTable { public:

    RadixIPLookup8();
    ~RadixIPLookup8();

    const char *class_name() const		{ return "RadixIPLookup8"; }
