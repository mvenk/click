// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP24_HH
#define CLICK_RADIXIPLOOKUP24_HH
...
class RadixIPLookup24 : public IPRouteTable { public:

    RadixIPLookup24();
    ~RadixIPLookup24();

    const char *class_name() const		{ return "RadixIPLookup24"; }
