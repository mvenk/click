// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP105_HH
#define CLICK_RADIXIPLOOKUP105_HH
...
RadixIPLookup105101101(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup105 : public IPRouteTable { public:

    RadixIPLookup105();
    ~RadixIPLookup105();

    const char *class_name() const		{ return "RadixIPLookup105"; }
