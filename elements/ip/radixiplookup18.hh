// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP18_HH
#define CLICK_RADIXIPLOOKUP18_HH
...
RadixIPLookup18(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup18 : public IPRouteTable { public:

    RadixIPLookup18();
    ~RadixIPLookup18();

    const char *class_name() const		{ return "RadixIPLookup18"; }
