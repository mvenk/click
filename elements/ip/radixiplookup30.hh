// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP30_HH
#define CLICK_RADIXIPLOOKUP30_HH
...
RadixIPLookup30(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup30 : public IPRouteTable { public:

    RadixIPLookup30();
    ~RadixIPLookup30();

    const char *class_name() const		{ return "RadixIPLookup30"; }
