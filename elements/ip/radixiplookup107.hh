// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP107_HH
#define CLICK_RADIXIPLOOKUP107_HH
...
RadixIPLookup107(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup107 : public IPRouteTable { public:

    RadixIPLookup107();
    ~RadixIPLookup107();

    const char *class_name() const		{ return "RadixIPLookup107"; }
  ...
  private:
    ...
    mutable ReadWriteLockUser _lock;
