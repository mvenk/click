// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP16_HH
#define CLICK_RADIXIPLOOKUP16_HH
...
RadixIPLookup16(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup16 : public IPRouteTable { public:

    RadixIPLookup16();
    ~RadixIPLookup16();

    const char *class_name() const		{ return "RadixIPLookup16"; }
