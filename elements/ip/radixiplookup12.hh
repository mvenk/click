// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP12_HH
#define CLICK_RADIXIPLOOKUP12_HH
...
RadixIPLookup12(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup12 : public IPRouteTable { public:

    RadixIPLookup12();
    ~RadixIPLookup12();

    const char *class_name() const		{ return "RadixIPLookup12"; }
