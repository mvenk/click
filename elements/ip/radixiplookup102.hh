// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP102_HH
#define CLICK_RADIXIPLOOKUP102_HH
...
RadixIPLookup102101101(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup102 : public IPRouteTable { public:

    RadixIPLookup102();
    ~RadixIPLookup102();

    const char *class_name() const		{ return "RadixIPLookup102"; }
