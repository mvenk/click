// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP104_HH
#define CLICK_RADIXIPLOOKUP104_HH
...
RadixIPLookup104101101(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup104 : public IPRouteTable { public:

    RadixIPLookup104();
    ~RadixIPLookup104();

    const char *class_name() const		{ return "RadixIPLookup104"; }
