// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUPCDF_HH
#define CLICK_RADIXIPLOOKUPCDF_HH
...
RadixIPLookupCDF(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookupCDF : public IPRouteTable { public:

    RadixIPLookupCDF();
    ~RadixIPLookupCDF();

    const char *class_name() const		{ return "RadixIPLookupCDF"; }
