// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP20_HH
#define CLICK_RADIXIPLOOKUP20_HH
...
RadixIPLookup20(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup20 : public IPRouteTable { public:

    RadixIPLookup20();
    ~RadixIPLookup20();

    const char *class_name() const		{ return "RadixIPLookup20"; }
