// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP3_HH
#define CLICK_RADIXIPLOOKUP3_HH
...
class RadixIPLookup3 : public IPRouteTable { public:

    RadixIPLookup3();
    ~RadixIPLookup3();

    const char *class_name() const		{ return "RadixIPLookup3"; }
