// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP10_HH
#define CLICK_RADIXIPLOOKUP10_HH
...
RadixIPLookup10(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup10 : public IPRouteTable { public:

    RadixIPLookup10();
    ~RadixIPLookup10();

    const char *class_name() const		{ return "RadixIPLookup10"; }
    const char *port_count() const		{ return "1/-"; }
    const char *processing() const		{ return PUSH; }

    static const int lglvl1 = 16;
    static const int lglvln = 16;
