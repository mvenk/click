// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP28_HH
#define CLICK_RADIXIPLOOKUP28_HH
...
RadixIPLookup28(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup28 : public IPRouteTable { public:
    ...
    const char *class_name() const		{ return "RadixIPLookup28"; }
