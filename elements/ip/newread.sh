# Creates a new readradixiplookup element from one which already exists
...
src_cc=readradixiplookup$src_n.cc
src_hh=readradixiplookup$src_n.hh

target_n=$2;
target_cc=readradixiplookup$target_n.cc
target_hh=readradixiplookup$target_n.hh
...
perl -i.bak -pe "s/CLICK_READRADIXIPLOOKUP${src_n}_HH/CLICK_READRADIXIPLOOKUP${target_n}_HH/g" $target_hh
