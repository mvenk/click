// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP29_HH
#define CLICK_RADIXIPLOOKUP29_HH
...
RadixIPLookup29(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup29 : public IPRouteTable { public:

    RadixIPLookup29();
    ~RadixIPLookup29();

    const char *class_name() const		{ return "RadixIPLookup29"; }
