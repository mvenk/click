// -*- c-basic-offset: 4 -*-
#ifndef CLICK_RADIXIPLOOKUP9_HH
#define CLICK_RADIXIPLOOKUP9_HH
...
RadixIPLookup9(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
class RadixIPLookup9 : public IPRouteTable { public:

    RadixIPLookup9();
    ~RadixIPLookup9();

    const char *class_name() const		{ return "RadixIPLookup9"; }
